...
import { THEME_COLORS, MenuSection } from "@/resume/types/resume";
import { ColorPicker } from "@/resume/ui/color-picker";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@/resume/ui/popover";
import { Plus } from "lucide-react";
import { STANDARD_MODULES } from "@/resume/config/modules";
import { DEFAULT_TEMPLATES } from "@/resume/config";
import { getFontOptions, normalizeFontFamily } from "@/resume/utils/fonts";

// 简版 debounce，避免引入 lodash
